    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <a href="https://api.whatsapp.com/send?phone=5491149488179" className="hidden md:flex py-1 px-3 text-white bg-green-600 rounded items-center justify-center my-auto font-semibold gap-2 border-2 border-green-600 hover:bg-transparent cursor-pointer">
          ...
          {menuItems.map((item) => (
            ...
            >
              {item}
                    ...
                    <a href="https://api.whatsapp.com/send?phone=5491149488179" className="flex mx-3 py-1 px-3 text-white bg-green-600 rounded items-center justify-center my-auto font-semibold gap-2 border-2 border-green-600 hover:bg-transparent cursor-pointer">
            <div className="relative h-8 w-8 flex items-center justify-center">
              <svg
                width="22"
                height="23"
