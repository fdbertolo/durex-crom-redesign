...
export default function ContactSection() {
  ...
  const handleSubmit = (e) => {
    ...
    const encodedData = new URLSearchParams({
      "form-name": "contact", // Asegúrate que este valor coincida con el `name` del formulario.
      ...formData,
    }).toString();
  ...
  return (
    <>
      {/* FORMULARIO OCULTO PARA NETLIFY:
        Este formulario no es visible para el usuario.
        Su único propósito es ser detectado por Netlify durante el build,
