...
export function ChromeSection() {
  ...
  return (
    <section id="cromo-duro" className="py-25 w-full bg-gradient-to-br from-[var(--durex-light)] to-white">
                ...
                <div className="space-y-3">
                  <div className="flex items-center p-3 bg-white/10 rounded-lg">
                    <div className="w-8 h-8 bg-[var(--durex-accent)] rounded-full flex items-center justify-center mr-3">
                      <span className="text-[var(--durex-dark)] font-bold text-sm">1</span>
                    </div>
                    <span className="text-sm">Preparación de superficie</span>
                  </div>
                  <div className="flex items-center p-3 bg-white/10 rounded-lg">
                    <div className="w-8 h-8 bg-[var(--durex-accent)] rounded-full flex items-center justify-center mr-3">
                      <span className="text-[var(--durex-dark)] font-bold text-sm">2</span>
                    </div>
                    <span className="text-sm">Inmersión electrolítica</span>
                  </div>
                  <div className="flex items-center p-3 bg-white/10 rounded-lg">
                    <div className="w-8 h-8 bg-[var(--durex-accent)] rounded-full flex items-center justify-center mr-3">
                      <span className="text-[var(--durex-dark)] font-bold text-sm">3</span>
                    </div>
                    <span className="text-sm">Depósito de cromo duro</span>
                  </div>
                  <div className="flex items-center p-3 bg-white/10 rounded-lg">
                    <div className="w-8 h-8 bg-[var(--durex-accent)] rounded-full flex items-center justify-center mr-3">
                      <span className="text-[var(--durex-dark)] font-bold text-sm">4</span>
                    </div>
              ...
              >
                <Card className="overflow-hidden hover:shadow-xl hover:scale-105 transition-all duration-300 border-0 bg-white">
                  <CardContent className="p-0">
                    <div className={`h-48 bg-gradient-to-br ${finish.gradient} ${finish.shadow} relative overflow-hidden`}>
                      {/* Chrome-like reflection effect */}
                      ...
                      <div className="absolute bottom-4 left-4 right-4">
                        <div className="bg-black/60 backdrop-blur-sm rounded-lg p-3 text-white">
                          ...
                          <p className="text-xs text-gray-200 mt-1">{finish.specs}</p>
                        </div>
                      </div>
                    </div>
                    <div className="p-6">
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-sm font-medium text-[var(--durex-primary)]">Rugosidad</span>
                        <span className="text-sm text-gray-500">{finish.specs}</span>
                      </div>
                    </div>
                  </CardContent>
                </Card>
